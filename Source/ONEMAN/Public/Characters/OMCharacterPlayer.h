...
public:
	...
	// Player State
	FORCEINLINE EPlayerNativeState GetPlayerNativeState() const { return PlayerNativeState; }
	FORCEINLINE void SetPlayerNativeState(EPlayerNativeState NewState) { PlayerNativeState = NewState; }
...
private:
	...
	************************/
	...
	EPlayerNativeState PlayerNativeState = EPlayerNativeState::Idle;
...
private:
	...
	************************/
	...
	float CharacterMovementSpeed = 450.0f;
...
private:
	...
	************************/
	...
	void Input_HandleRollOrJump(const FInputActionValue& InputActionValue);

	void Input_SprintTriggered(const FInputActionValue& InputActionValue);
	void Input_SprintCompleted(const FInputActionValue& InputActionValue);

	void Input_SwitchTargetTriggered(const FInputActionValue& InputActionValue);
	void Input_SwitchTargetCompleted(const FInputActionValue& InputActionValue);

	void Input_UsingPotionsStarted(const FInputActionValue& InputActionValue);
