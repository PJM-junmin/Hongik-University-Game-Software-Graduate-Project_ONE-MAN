...
public:
	...
	void GrantPlayerWeaponAbilities(const TArray<FOMPlayerAbilitySet>& InDefaultWeaponAbilities, 
		const TArray<FOMPlayerSpecialAbilitySet>& InSpecialWeaponAbilities,  
